...
<form action="<?=base_url('travel/paket/'.$data_paket['id_paket_travel'].'/foto/upload')?>"  method="post" enctype="multipart/form-data" class="dropzone tab-pane fade <?php if($mode=='foto') echo 'show active'; ?> bg-dark p-3 text-white" id="tableFoto" >
