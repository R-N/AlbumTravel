...
class Foto_model extends General_model {
    ...
    function fetch_foto_album($id_album, $limit=20, $offset=0, $search=null){
        $sql = "
            ...
            FROM 
                ...
                TRAVEL T 
            WHERE 
                F.id_foto=FG.id_foto 
                AND ABG.id_album=? 
                AND ABG.id_paket_travel=PT.id_paket_travel 
                AND FG.id_paket_travel=PT.id_paket_travel 
        ...
        $sql2 = "
            ...
            FROM 
                ...
                CUSTOMER C 
            WHERE 
                F.id_foto=FA.id_foto 
                AND FA.id_anggota=AG.id_anggota_grup 
                AND AG.id_anggota_grup=ABA.id_anggota 
                AND ABA.id_album=? 
        ...
        $sql3 = "
            ...
            WHERE 
                ...
                AND FG.id_paket_travel=AG.id_paket_travel 
                AND AG.id_customer=C.id_customer 
                AND C.id_pengguna=?
        ";
        $sql4 = "
    ...
    function get_url_foto_anggota($id_foto){
        $sql = '
            ...
            WHERE 
                F.id_foto=? 
                AND F.id_foto=FG.id_foto 
                AND FG.id_anggota=AG.id_anggota_grup 
                AND AG.id_customer=C.id_customer 
                AND C.id_pengguna=?
        ';
        $sql2 = '
    ...
    function delete_foto_anggota($id_foto){
        ...
        $sql = '
            ...
            WHERE 
                FA.id_foto=? 
                AND FA.id_customer=C.id_customer 
                AND C.id_pengguna=?
        ';
